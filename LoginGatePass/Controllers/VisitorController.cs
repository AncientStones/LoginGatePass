...
namespace LoginGatePass.Controllers
{
    public class VisitorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Gender,Address,City,State,Telephone,Company,Purpose,DateBooked,VisitorCount")] Visitor visitors)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Gender,Address,City,State,Telephone,Company,Purpose,DateBooked,VisitorCount")] Visitor visitors)
        {
            if (id != visitors.Id)
            {
                return NotFound();
